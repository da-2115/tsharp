...
// Variable assignment
assignment: TYPE=type NAME=ID EQUALS (VALUE=(STRING_LIT|NUM|FLOAT_LIT|PI)|SQUARE_ROOT=square_root);
...
println_statement: PRINTLN OPEN_BRACKET (MESSAGE=STRING_LIT|VAR=ID|SQUARE_ROOT=square_root|PI_CONST=PI) CLOSE_BRACKET;
print_statement: PRINT OPEN_BRACKET (MESSAGE=STRING_LIT|VAR=ID|SQUARE_ROOT=square_root|PI_CONST=PI) CLOSE_BRACKET;
